                                        ...
                                        <div class="tab-pane fade show active" id="underline-home" role="tabpanel" aria-labelledby="underline-home-tab">
                                            <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                                                    ...
                                                    <fieldset class="scheduler-border shadow p-3 mb-5 bg-white rounded" style="border-radius: 10px; color:black;">
                                                        ...
                                                        <div class="container-fluid mb-5 shadow-sm p-3 mb-5 bg-white rounded" style="width: 90%; border-radius: 10px;">
                                                            ...
                                                            <div class="row text-left mb-3">
                                                                ...
                                                                <div class="col-sm-5">
                                                                    <label>Enviar a analista de calidad</label>
                                                        ...
                                                        <div class="container-fluid mb-6">
                                                            <textarea style="padding-left: 20px; padding-top: 20px; width: 90%; height: 100px; border: 1px solid #A5A5A5 ;" spellcheck="false" id="textarea_obs" placeholder="">
                                                        </textarea>
                                                        </div>
                                                ...
                                                <div style="text-align: center;" class="mb-5">
                                                    ...
                                                    <button onclick="llamar_vista('be_Editor_view')" class="btn btn-primary" id="btnbandeja_entrada">Bandeja de entrada
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-cpu">
                                                            <rect x="4" y="4" width="16" height="16" rx="2xa" ry="2"></rect>
            ...
            <script>
                                                $('.widget-content .warning.cancel').on('click', function() {
                                                    ...
                                                    swalWithBootstrapButtons({
                                                        title: 'El tramite se asignara al: <br> Analista de calidad para revisión de Pre Resolución',
