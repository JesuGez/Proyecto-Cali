                                            ...
                                            <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                                                ...
                                                <div class="info">
                                                    ...
                                                    <fieldset class="scheduler-border shadow p-3 mb-5 bg-white rounded" style="border-radius: 10px; color:black;">
                                                        ...
                                                        <div class="container-fluid mb-5 shadow-sm p-3 mb-5 bg-white rounded" style="width: 90%; border-radius: 10px;">
                                                            <br>
                                                        ...
                                                        <label for="" style="margin-left: 30px;"><b>Observaciones</b></label>
                                                        <div class="container-fluid mb-6">
                                                            <textarea style="padding-left: 20px; padding-top: 20px; width: 90%; height: 100px; border: 1px solid #A5A5A5 ;" spellcheck="false" id="textarea_obs" value="Envío para analisis cartografico solicitando la verificación de la pertinencia de la información a incorporar, posterior a la
                                                                revisión técnica debe ser enviada al Técnico de visitas terreno y posteriormente al digitador o editor fulanito de tal para
                                                                la generación de la pre resolución respectiva.">
                                                            </textarea>
                                                        </div>
                                                    </fieldset>
                                                ...
                                                <div style="text-align: center;" class="mb-5">
                                                    ...
                                                    <button onclick="llamar_vista('be_aJuridico_view')" class="btn btn-primary" id="btnbandeja_entrada">Bandeja de entrada
