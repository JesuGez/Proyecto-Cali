                                            ...
                                            <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                                                ...
                                                <div class="info">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <input type="text" id="id_matricula" class="form-control" value="232" disabled>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-4">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-sm-7">
                                                                                <input type="text" id="id_npm" class="form-control" value="7600201000045404000000" disabled>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <fieldset class="scheduler-border shadow p-3 mb-5 bg-white rounded">
                                                        ...
                                                        <div class="container-fluid mb-5" style="border: 1px solid #DCE6E6; width: 90%; border-radius: 10px;">
                                                            <br>
                                                            <div class="row text-left" style="margin-bottom:40px;">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <label>Editor o Digitador Asignado por Lider de Mutación:</label>
                                                                    <input class="form-control" type="text" placeholder="Wilson enrique gonzales" readonly>
                                                                </div>
                                                                <div class="col-sm-3">
                                                        ...
                                                        <div class="container-fluid mb-5" style="border: 1px solid #DCE6E6; width: 90%; border-radius: 10px;">
                                                            ...
                                                            <div class="row text-left mb-3">
                                                                ...
                                                                <div class="col-sm-5">
                                                                    <label>Devolver a usuario anterior</label>
                                                        ...
                                                        <div class="container-fluid mb-5" style="border: 1px solid #DCE6E6; width: 80%; border-radius: 10px; margin-left: 40px;">
                                                ...
                                                <div style="text-align: center;" class="mb-5">
                                                    <button class="btn btn-success warning cancel" id="btnasignar_tramite" onclick="llamar_vista('be_aCartografico_view')">Asignar Tramite
                                                    ...
                                                    <button onclick="llamar_vista('tabs_tVisitas_view')" class="btn btn-primary" id="btnbandeja_entrada">Reresar a Bandeja de entrada
            ...
            <script>
                                                $('.widget-content .warning.cancel').on('click', function() {
                                                    ...
                                                    swalWithBootstrapButtons({
                                                        title: 'El tramite se asignara al: <br> Editor: Joaquin valencia <br> Cartografico: Jorge Gomez',
