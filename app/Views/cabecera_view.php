            ...
            <ul class="navbar-item flex-row nav-dropdowns">
                ...
                <li class="nav-item dropdown notification-dropdown">
                    ...
                    <div class="dropdown-menu position-absolute" aria-labelledby="notificationDropdown">
                        <div class="notification-scroll">
                            ...
                            <div class="dropdown-item">
                                <button class="switchDark2 active ml-5" id="switch2">
                                    <span id="span-dark"><i class="fa fa-sun-o" style="font-size:23px;"></i></span>
                                    <span id="span-dark"><i class="fa fa-moon-o" style="font-size:23px;" ></i></span>
                                </button>
                            </div>
                            <div class="dropdown-item">
                                <div class="text-center">
                                    <label for="exampleColorInput" class="form-label mt-2" style="color: black;"><b>Personaliza tu interfaz: </b></label><br>
                                    <input type="color" class=" form-control-color" id="colorPicker2" value="" title="Escoge un color:">
                                </div>
                            </div>    
                    ...
                    <script>
                        ...
                        const switchButton = document.getElementById('switch2');
                        switchButton.addEventListener('click',()=>{
                            document.body.classList.toggle('dark');
                            switchButton.classList.toggle('active')
                        })
                    ...
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="user-profile-dropdown"
                        ...
                        <div class="media">
                            <div class="media-body align-self-center">
                                <h4 style="color:white;">Lider Mutacion</h4>
