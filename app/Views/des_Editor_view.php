                                            ...
                                            <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                                                ...
                                                <div class="info">
                                                    ...
                                                    <fieldset class="scheduler-border shadow p-3 mb-5 bg-white rounded" style="border-radius: 10px; color:black;">
                                                        <legend style="border-bottom:none;  width:inherit; padding:0 10px;">
                                                            <p style="font-size: 15px;"><b>Desenglobe</b></p>
                                                        </legend>
                                                        ...
                                                        <div class="container-fluid pl-3">
                                                            <div class="row layout-top-spacing" id="cancel-row">
                                                                <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                                                                    <table id="table_desenglobar" class="table table-hover non-hover table-responsive" style="border-radius: 10px;">
                                                                        <thead>
                                                                            <tr>
                                                ...
                                                <div class="text-center" class="mb-5">
                                                    <div class="row">
                                                        ...
                                                        <div class="col">
                                                            <button class="btn btn-primary" onclick="llamar_vista('ecd_Editor_view')" id="btncontinuar">Desenglobar predio</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
