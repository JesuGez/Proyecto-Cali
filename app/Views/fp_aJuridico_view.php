<div id="ver_asignar_tramite">
    ...
    <div class=" container container-fluid" style="color: black;">
        ...
        <div class="account-settings-container layout-top-spacing">
            ...
            <div class="row">
                <div class="col-lg-12 mx-auto" style="background-color: #283747;">
                    <center>
                        <h2 style="color: white; padding: 10px;">Ficha Pedrial Catastral</h2>
                    </center>
                </div>
            </div>
        </div><br>
        <div class="row">
            <div class="col-lg-12 mx-auto">
                <div class="row">
                    <div class="col-sm-4">Ficha Catastral: <b>Identificador del Predio (12345)1</b></div>
                    <div class="col-sm-4" style="text-align: center;">Estado del predio: <b>ACTIVO</b></div>
                    <div class="col-sm-4">
                        <a style="color:blue;" href="https://drive.google.com/file/d/1BRUJ1gKDGm7_5Jlrhl0UFEdBsvWziyIr/view?usp=sharing">Ver historial(Resoluciones)</a>
                    </div>
                </div>
            </div>
        </div><br><br>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="col-sm-6">
                    <fieldset class="scheduler-border shadow pb-3 pt-3 pl-3 mb-5 bg-white rounded">
                        <legend style="border-bottom:none;  width:inherit; padding:0 10px;">
                            <p style="font-size: 15px;"><b>INFORME FISICO JURIDICO:</b></p>
                        </legend>
                        <div class="row">
                            <div class="col-sm-4">
                                <label class="dob-input">Tipo DOC:</label>
                                <input type="text" id="id_predio" class="form-control" disabled placeholder="" value="12345">
                            </div>
                            <div class="col-sm-5">
                                <div class="mapouter">
                                    <div class="gmap_canvas">
                                        <iframe width="1080" height="267" id="gmap_canvas" src="https://maps.google.com/maps?q=Cali&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
                                        ...
                                        <a href="https://www.embedgooglemap.net">how to add google map to my website</a>
                                        <style>
                                            .gmap_canvas {
                                                overflow: hidden;
                        ...
                        <div class="row">
                            <div class="col-sm-8">
                                <label class="dob-input">Nombres y apellidos:</label>
                                <input type="text" id="id_predio" class="form-control" disabled placeholder="" value="12345">
                            </div>
                        </div><br>
                        <div class="row">
                            <div class="col-sm-4">
                                <label class="dob-input">%Participación:</label>
                                <input type="text" id="id_predio" class="form-control" disabled placeholder="" value="12345">
                            </div>
                            <div class="col-sm-6">
                                <label class="dob-input">Tipo Derecho:</label>
                    ...
                    <fieldset class="scheduler-border shadow p-3 mb-5 bg-white rounded">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <label class="dob-input">Numero Documento:</label>
                                <input type="text" id="id_nupre" class="form-control">
                            </div>
                        </div>
                        <br>
            ...
            <div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <br>
                        <br>
                        <button type="button" onclick="llamar_vista('tabs_aJuridico_view')" class="btn btn-outline-primary" style="margin: -10px;">Ver ficha predial</button>
                    </div>
                    <div class="col-sm-2">
                        <br>
                        <br>
    ...
    <fieldset class="scheduler-border" style="border: 1px solid black; border-radius: 10px; color:black;">
        ...
        <br>
        <fieldset class="scheduler-border mx-2 my-2" style="border: 1px solid black; border-radius: 10px; color:black;">
            <legend style="border-bottom:none;  width:inherit; padding:0 10px;">
            ...
            <div class="row text-left">
                ...
                <center><button class="btn btn-outline-success" id="btncertificado_pdf">+ Certificados de Tradición(otros)-PDF
                    ...
                    <center><br>
                        ...
                        <label style="margin-left: -870px;"><b>Observaciones</b></label>
                        <div class="container-fluid mb-5" style="border: 1px solid black; width: 90%; border-radius: 10px;">
                            <p style="color: black;">Envío para analisis fisico juridico y verificación sobre pertinencia de la información a incorporar, posterior a la revisión
                                técnica fisica juridica el tramite debe ser enviado al digitador o editor fulanito de tal para la generación de la pre
                                resolución respectiva.</p>
...
<fieldset class="scheduler-border mx-4" style="border: 1px solid black; border-radius: 10px; color:black;">
    <legend style="border-bottom:none;  width:inherit; padding:0 10px;">
...
<fieldset class="scheduler-border mx-4" style="border: 1px solid black; border-radius: 10px; color:black;">
    ...
    <label style="margin-left: 60px;"><b>Observaciones Planos:</b></label>
    <div class="container-fluid mb-5" style="border: 1px solid black; width: 90%; border-radius: 10px;">
        <p style="color: black;">Envío para analisis fisico juridico y verificación sobre pertinencia de la información a incorporar, posterior a la revisión
            técnica fisica juridica el tramite debe ser enviado al digitador o editor fulanito de tal para la generación de la pre
            resolución respectiva.</p>
...
<fieldset class="scheduler-border mx-4" style="border: 1px solid black; border-radius: 10px; color:black;">
    ...
    <div class="container-fluid mb-3" style="border: 1px solid black; width: 90%; border-radius: 5px;">
...
<div class="mapouter">
    <div class="gmap_canvas"><iframe width="250" height="267" id="gmap_canvas" src="https://maps.google.com/maps?q=Cali&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="4" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://123movies-to.org">123movies</a><br>
        <style>
            .mapouter {
                position: relative;
                text-align: right;
        ...
        </style><a href="https://www.embedgooglemap.net">how to add google map to my website</a>
        <style>
            .gmap_canvas {
                overflow: hidden;
                background: none !important;
